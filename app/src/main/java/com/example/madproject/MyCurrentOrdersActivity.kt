...
class MyCurrentOrdersActivity : AppCompatActivity(), currentorder.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerAdapter = currentorder(this, currentOrderList,this)

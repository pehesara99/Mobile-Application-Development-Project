...
class Register : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //storageRef = FirebaseStorage.getInstance().reference.child("customer")
                    ...
                    currentUser!!.updateProfile(profileUpdates)
                        .addOnCompleteListener { it ->
                            if(it.isSuccessful) {
                                ...
                                addEmployeeDetailsToDatabase(currentUser)
    ...
    private fun addEmployeeDetailsToDatabase(user: FirebaseUser) {

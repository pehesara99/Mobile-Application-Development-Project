...
class DatabaseHandler(val context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, 1) {
    ...
    fun readCartData(): MutableList<CartItem> {
        ...
        if (result.moveToFirst()) {
            do {
                val item = CartItem()
                item.itemID = result.getString(result.getColumnIndexOrThrow(CART_ITEM_ID)).toString()
                item.imageUrl =
                    result.getString(result.getColumnIndexOrThrow(CART_IMAGE_URL)).toString()
                item.itemName = result.getString(result.getColumnIndexOrThrow(CART_ITEM_NAME)).toString()
                item.itemPrice = result.getFloat(result.getColumnIndexOrThrow(CART_ITEM_PRICE))
                item.itemShortDesc =
                    result.getString(result.getColumnIndexOrThrow(CART_ITEM_SHORT_DESC)).toString()
                item.quantity = result.getInt(result.getColumnIndexOrThrow(CART_ITEM_QTY))
                item.itemStars = result.getFloat(result.getColumnIndexOrThrow(CART_ITEM_STARS))
    ...
    fun readCurrentOrdersData(): MutableList<CurrentOrderItem> {
        ...
        if (result.moveToFirst()) {
            do {
                ...
                item.orderID = result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_ID))
                item.takeAwayTime =
                    result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_TAKE_AWAY_TIME))
                item.paymentStatus =
                    result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_PAYMENT_STATUS))
                item.orderItemNames =
                    result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_ITEM_NAMES))
                item.orderItemQuantities =
                    result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_ITEM_QUANTITIES))
                item.totalItemPrice =
                    result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_TOTAL_ITEM_PRICE))
                item.tax = result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_TAX))
                item.subTotal = result.getString(result.getColumnIndexOrThrow(COL_CURRENT_ORDER_SUB_TOTAL))
                list.add(item)
            } while (result.moveToNext())
        }
    ...
    fun readOrderData(): MutableList<OrderHistoryItem> {
        ...
        if (result.moveToFirst()) {
            do {
                ...
                item.date = result.getString(result.getColumnIndexOrThrow(COL_ORDER_DATE))
                item.orderId = result.getString(result.getColumnIndexOrThrow(COL_ORDER_ID))
                item.orderStatus = result.getString(result.getColumnIndexOrThrow(COL_ORDER_STATUS))
                item.orderPayment = result.getString(result.getColumnIndexOrThrow(COL_ORDER_PAYMENT))
                item.price = result.getString(result.getColumnIndexOrThrow(COL_ORDER_PRICE))
                item.id = result.getString(result.getColumnIndexOrThrow(COL_ID)).toInt()
                list.add(item)
            } while (result.moveToNext())
        }
    ...
    fun readSavedCardsData(): MutableList<SavedCardItem> {
        ...
        if (result.moveToFirst()) {
            do {
                ...
                item.cardNumber = result.getString(result.getColumnIndexOrThrow(COL_SAVED_CARD_NUMBER))
                item.cardHolderName =
                    result.getString(result.getColumnIndexOrThrow(COL_SAVED_CARD_HOLDER_NAME))
                item.cardExpiryDate =
                    result.getString(result.getColumnIndexOrThrow(COL_SAVED_CARD_EXPIRY_DATE))
                list.add(item)
            } while (result.moveToNext())
        }
